var EventEmitter, Nicovideo, async, fs, parseString, path, querystring, request, _;
...
Nicovideo.prototype = {
  ...
  download: function(video_id) {
    ...
    async.waterfall([
      function(callback) {
        return Nicovideo.prototype.sign_in(callback);
      }, function(_status, callback) {
        ev.emit('signed', _status);
        return Nicovideo.prototype.get_video(video_id, callback);
      }, function(_status, callback) {
        return Nicovideo.prototype.get_flv(video_id, callback);
      }, function(_status, _flvinfo, callback) {
        meta = _.extend(meta, _flvinfo);
        return Nicovideo.prototype.get_thumbinfo(video_id, callback);
        ...
        return Nicovideo.prototype.http_export(meta.url, meta.filepath, callback);
      }, function(callback) {
