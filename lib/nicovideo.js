...
Nicovideo = function(options) {
  ...
  return this.output = options.output;
};
...
Nicovideo.prototype = {
  ...
  download: function(video_id) {
    ...
    async.waterfall([
      function(callback) {
        return self.sign_in(callback);
      }, function(_status, callback) {
        ev.emit('signed', _status);
        return self.get_video(video_id, callback);
      }, function(_status, callback) {
        return self.get_flv(video_id, callback);
      }, function(_status, _flvinfo, callback) {
        meta = _.extend(meta, _flvinfo);
        return self.get_thumbinfo(video_id, callback);
        ...
        return self.http_export(meta.url, meta.filepath, callback);
      }, function(callback) {
